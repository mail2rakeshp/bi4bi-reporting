...
from anaconda_navigator.widgets import ButtonLabel, ButtonLink, ButtonNormal, FrameBase, LabelBase
...
class ListItemApplication(ListWidgetItemBase):
    ...
    def launch_application(self) -> None:
        ...
        if self.app_type == AppType.WEB:
            command = external_apps.web_apps[self.name](config=self.api.config).url
        else:
