...
def listdir(path, include='.', exclude=r'\.pyc$', show_all=True, folders_only=False):
...
class DirView(QTreeView):
    ...
    def setup_common_actions(self):
        ...
        all_action = create_action(self, "Show all files", toggled=self.toggle_all)
    ...
    def delete_file(self, fname, multiple, yes_to_all):
        ...
        try:
            ...
            msg_box = MessageBoxError(
                ...
                "<br><br>Error message:<br>%s" % (action_str, fname, to_text_string(error)),
        ...
        if dlg.exec_():
            ...
            if osp.exists(path):
                msg_box = MessageBoxQuestion(
                    ...
                    "overwrite the existing file <b>%s</b>?" % (osp.basename(fname), osp.basename(path)),
                )
            ...
            try:
                ...
                msg_box = MessageBoxError(
                    ...
                    "<br><br>Error message:<br>%s" % (osp.basename(fname), to_text_string(error)),
                    title='Rename error',
                )
                msg_box.exec_()
        ...
        for fname in fnames:
            ...
            try:
                ...
                msg_box = MessageBoxError(
                    ...
                    "<br><br>Error message:<br>%s" % (basename, to_text_string(error)),
                    title='Error',
                )
                msg_box.exec_()
        ...
        if dlg.exec_():
            ...
            try:
                ...
                msg_box = MessageBoxError(
                    ...
                    "<br><br>Error message:<br>%s" % (dirname, to_text_string(error)),
                    title=title,
                )
                msg_box.exec_()
            finally:
                if is_package:
                    ...
                    try:
                        ...
                        msg_box = MessageBoxError(
                            ...
                            "<br><br>Error message:<br>%s" % (fname, to_text_string(error)),
                            title=title,
                        )
                        msg_box.exec_()
        ...
        if fname:
            try:
                ...
                msg_box = MessageBoxError(
                    ...
                    "</b><br><br>Error message:<br>%s" % (fname, to_text_string(error)),
...
class ExplorerTreeWidget(DirView):
    ...
    def setup_common_actions(self):
        ...
        if self.show_cd_only is None:
            ...
            cd_only_action = create_action(self, "Show current directory only", toggled=self.toggle_show_cd_only)
