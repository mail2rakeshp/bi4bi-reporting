...
class EndpointCollection(typing.Mapping[str, typing.Any]):
    ...
    def __init__(self, base_url: str, endpoints: typing.Mapping[str, typing.Any]) -> None:
        ...
        self.__base_url: 'typing_extensions.Final[str]' = base_url
        ...
        self.__endpoints: 'typing_extensions.Final[typing.Mapping[str, typing.Union[str, EndpointCollection]]]' = data
