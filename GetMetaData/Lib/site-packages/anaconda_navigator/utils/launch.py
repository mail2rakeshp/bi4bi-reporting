...
if typing.TYPE_CHECKING:
    ...
    class GetCommand(typing_extensions.Protocol):
...
class RunningProcess:
    ...
    def cleanup(self) -> None:
        ...
        path: str
        for path in filter(bool, [self.__stdout, self.__stderr]):
            try:
                os.remove(path)
            except OSError:
                pass
...
def get_package_logs(
    ...
    if id_ is None:
        ...
        for id_ in itertools.count(start=1):
        ...
        id_ = typing.cast(int, id_)  # in case linter assumes that application can omit `for` body
...
def launch(
    ...
    return RunningProcess(
        ...
        process=subprocess.Popen(args, **popen_dict),
...
def check_prog(prog, prefix=None) -> bool:
